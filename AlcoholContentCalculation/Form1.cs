    ...
    public partial class Form1 : Form
    {
        ...
        private void CalcButtonClicked(object sender, EventArgs e)
        {
            ...
            if (changeSuccesses == true)
            {
                ...
                int oneGlassAlcohol = OneGlassAlcoholCalc(alcoholMaterial,amountMaterial, noAlcohol ,
        ...
        {
            int oneGlassAlcohol = ((alcoholMaterial * amountMaterial) + (SecondAlcoholMaterial * SecondAmountMaterial)
                                    + (ThirdAlcoholMaterial * ThirdAmountMaterial)) / (amountMaterial + SecondAmountMaterial + ThirdAmountMaterial 
                                        +  noAlcohol + SecondNoAlcohol + ThirdNoAlcohol);
